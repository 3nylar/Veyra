...
- Array []
+ Array [
+   "Connecting to 'ws://127.0.0.1:5173/?token=WwBO_yoA_UY2' violates the following Content Security Policy directive: \"connect-src https: http://localhost:* http://127.0.0.1:*\". The action has been blocked.",
+ ]
```
